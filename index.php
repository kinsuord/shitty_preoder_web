...
<html lang="zh-Hant-TW" class="no-js">
    ...
    <head>
        ...
        <meta content="想吃到來自「美食之都」台南的嗎 ?
            想輕鬆吃到來自「美食之都」台南的嗎 ?
            這些事情，南友會府城週通通都能幫妳做到!!!" name="description"/>
    ...
    <body id="body" data-spy="scroll" data-target=".header">
                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            <ul class="nav navbar-nav navbar-nav-right">
                                ...
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-shopping-cart" href="shoppingcart.php" title="購物車"><i class="material-icons">shopping_cart</i></a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- End Navbar Collapse -->
        ...
        <!-- About -->
        <div id="about">
            <div class="content-lg container bg-color-sky-light">
                <div class="row container">
                    <div class="col-md-7 md-margin-b-60">
                    ...
                    <div class="margin-t-50 col-md-5 float-right">
        ...
        <div id="pre-order">
            <div class="container">          
                <div class="row margin-b-40 order-title">
                    <h1>預購</h1>
                    <p>野台預購期間，可以來野台繳網路預購的費用，也可以直接在野台填單繳費，並且在熟食展期間(10/24二~10/26四)領貨(重要!)
                ...
                <div id="cake" class="order-company bg-color-sky-light">
                    <h2>里夫蛋糕</h2>
                    <div class="row order-item">                      
                        <div class="col-sm-5 margin-b-20">
                ...
                <div id="luwei" class="order-company">
                    <h2>西井村滷味</h2>
                    <p>不含防腐劑，保存期限:冷藏2天、冷凍6個月、常溫可放6~8個小時(所有滷味都是)
                    </p>
                    <div class="row order-item">
                        ...
                        <div class="col-sm-4 margin-b-20 order-item">
                            <img class="img-responsive" src="img/970x647/01.jpg" alt="組合包">
                            <h4>組合包 :  220/包</h4>
                ...
                <div id="mango" class="order-company bg-color-sky-light">
                <h2>玉井芒果乾 :  100/包</h2>
                    <div class="row order-item">                      
                        <div class="col-sm-5 margin-b-20">
                ...
                <div id="shrimp" class="order-company bg-color-sky-light">
                <h2>蝦到爆蝦餅 :  80/包</h2>
                    <div class="row order-item">                      
                        <div class="col-sm-5 margin-b-20">
                        ...
                        <div class="col-sm-7 margin-b-50 order-context"> 
                            <p>約80g，包裝差不多A4紙大小，不含防腐劑，賞味期約10日，保存期限15日
                            (打開之後只能放10天的意思)</p>
                            <form class="order-form" action="./php/addtocart.php" method="post">
                              <label ><p>鹽味</p></label>
                ...
                <h2>連德堂煎餅 :  45/包</h2>
                    <div class="row order-item">                      
                        ...
                        <div class="col-sm-7 margin-b-50 order-context"> 
                            <p>這次府城週限量180包，需要的話請前往野台預購。一包大概一個手掌大，
        ...
        <div id="order">
            <div class="section-seperator">
                <div class="content-md container bg-color-sky-light">
                    <div class="row margin-b-40">
                        <div class="col-sm-6">
                            <h2>訂單查詢與修改</h2>
                            <p>想確認自己訂甚麼和修改嗎</p>
                            <a href="#" class="btn-theme btn-theme-sm btn-white-bg text-uppercase">按這裡</a>
                        </div>
                    </div>
                    <!--// end row -->
